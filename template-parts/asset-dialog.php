	...
	<div class="mdc-card__action-icons large-asset-card__action-bar">
		<div class="large-asset-card__actions-link">
			<div class="large-asset-card__link-copy">
				<i asset-id="{{ id }}" class="dialog-access-trigger large-asset-card__link-copy-button mdc-icon-button material-icons mdc-card__action mdc-card__action--icon--unbounded copy" data-clipboard-text="{{permalink}}">link</i><input data-clipboard-text="{{permalink}}" asset-id="{{ id }}" class="dialog-access-trigger copy" type="text" value="{{permalink}}" readonly></input>
			</div>
			<div asset-id="{{ id }}" class="dialog-access-trigger large-asset-card__link-download mdc-button mdc-ripple"><a href="{{permalink}}" download="{{filename}}"><span class="mdc-button__ripple"></span>Download</a></div>
            ...
            <div class="mdc-menu-surface--anchor">
                ...
                <div class="mdc-menu mdc-menu-surface mdc-dialog-menu mdc-dialog-menu-surface" data-toggle="collapse" tabindex="-1" style="transform-origin: center bottom 0px; left: 0px; bottom: 0px; max-height: 900.8px;">
                    <ul class="mdc-list" role="menu" aria-hidden="true">
                        {{if is_image }}
                        <a class="mdc-list-item mdc-ripple mdc-card-menu-item" role="menuitem" tabindex="-1">Get web resolution</a>
                        <li class="mdc-list-divider" role="separator"></li>
                        {{/if}}
                        <a class="mdc-list-item mdc-ripple mdc-card-menu-item" role="menuitem" tabindex="-1">Send in email</a>
