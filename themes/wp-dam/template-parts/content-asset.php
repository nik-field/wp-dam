		...
		<div class="large-asset-card__content">
			<div class="large-asset-card__primary">
				...
				<a href="<?php echo get_asset_url(); ?>"><?php endif; ?>
					<h2 class="large-asset-card__title mdc-typography mdc-typography--headline4 
					<?php
					if ( get_asset_format() !== 'format_link' ) :
						?>
						open-dialog <?php endif; ?>"><?php the_title(); ?></h2>
					<?php
					if ( get_asset_format() === 'format_link' ) :
						?>
				</a><?php endif; ?>
				...
				<div class="large-asset-card__actions mdc-card__actions">
					<div class="mdc-card__action-icons large-asset-card__action-bar">
						<div class="large-asset-card__actions-link">
							...
							<div asset-id="<?php the_ID(); ?>" class="access-trigger large-asset-card__link-download mdc-button mdc-ripple"><a href="<?php echo $fileLink; ?>" download><span class="mdc-button__ripple"></span>
									<?php
									if ( get_asset_format() !== 'format_link' ) :
										echo 'Download';
else :
