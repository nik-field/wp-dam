		...
		<header id="masthead" class="site-header mdc-top-app-bar--prominent mdc-elevation--z4 mdc-layout-grid">
			...
			<div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-12 mdc-layout-grid__cell--align-middle">
				<section class="site-branding mdc-top-app-bar__section mdc-layout-grid__inner">
					...
					<svg height="33" viewBox="0 0 33 33" width="33" xmlns="http://www.w3.org/2000/svg"><defs><style>.a{fill:rgba(255,219,88,.6)}.b{fill:#ffdb58}</style></defs><rect class="a" height="11" width="11" transform="translate(22) rotate(90)"/><rect class="a" height="11" width="11" transform="translate(33 11) rotate(90)"/><rect class="a" height="11" width="11" transform="translate(22 22) rotate(90)"/><rect class="a" height="11" width="11" transform="translate(11 11) rotate(90)"/><rect class="b" height="11" width="11"/><rect class="b" height="11" width="11" transform="translate(22)"/><rect class="b" height="11" width="11" transform="translate(22 22)"/><rect class="b" height="11" width="11" transform="translate(0 22)"/></svg>
						<?php bloginfo( 'name' ); ?>
				</span>
				<?php
		...
		<div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-12">
    		<div class="mdc-layout-grid__inner">
    		    <section class="dam-search-bar mdc-layout-grid__cell mdc-layout-grid__cell--span-12">
    		        ...
    		        <div class="dam-search-input mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon">
                      <i class="material-icons mdc-text-field__icon">search</i>
                      <input class="mdc-text-field__input" id="text-field-hero-input">
